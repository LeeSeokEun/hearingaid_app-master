...
public class TTS_STT extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnCallMain = (Button) findViewById(R.id.button3);
        btnCallMain.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {

                Intent intent = new Intent(TTS_STT.this, EmotionResult.class);
                intent.putExtra("txtText", txtText.getText().toString());
                //Log.i("Text",  txtText.getText().toString());
